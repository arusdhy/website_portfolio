...
import { ArrowRight, ChevronDown, Globe, Mail, Download } from "lucide-react";
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="txt-5xl font-bold md:text-6xl lg: text-7xl leading-tight animate-fade-in animation-delay-100">
                        ...
                        <p className="txt-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                    ...
                    <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                        <span className="txt-sm text-muted-foreground">
                            Follow me on:
                        </span>
                        {[
                            { icon: Globe, href: "https://github.com/arusdhy" },
                            { icon: Mail, href: "https://www.linkedin.com/in/ayla-rusdhy" },
                        ].map((social, idx) => (
                            <a 
                            key={idx}
                            href={social.href}
                ...
                <div className="relative animate-fade-in animation-delay-300">
                    ...
                    <div className="relative max-w-md mx-auto">
                        <div className=" absolute inset-0 rounded-3xl bg-gradient-to-br from-primary/30 via-transparent to-primary/10 blur-2xl animate-pulse-glow" />
                            <img src="/profile.jpg" alt="Ayla Rusdhy" className="w-full aspect-[4/5] object-cover rounded-2xl" />
                            ...
                            <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
                                ...
                                <div className="text-xs text-muted-foreground">Gradute</div>
                            </div>
